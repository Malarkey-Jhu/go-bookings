...
// SearchAvailablityByDatesByRoomID return true when a room(roomID) is available , false otherwise
...
//SearchAvailablityForAllRooms returns a slice of availabe rooms, if any for given date range
